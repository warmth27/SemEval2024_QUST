...
_BASE_URL = 'https://www.modelscope.cn/api/v1/datasets/simpleai/HC3/repo?Revision=master&FilePath='
# _URLS = {
...
class NewDataset(datasets.GeneratorBasedBuilder):
    """The ChatGPT Comparison Corpus (C3)"""
    ...
    BUILDER_CONFIGS = [
        ...
        datasets.BuilderConfig(name="wikipedia_csai", version=VERSION, description="wiki"),
        datasets.BuilderConfig(name="open_questions", version=VERSION, description="open_questions"),
    ...
    def _split_generators(self, dl_manager):
        ...
        return [
            ...
            #     # These kwargs will be passed to _generate_examples
            #     gen_kwargs={
            #         "filepath": os.path.join(data_dir, "dev1.jsonl"),
            #         "split": "dev",
            #     },
            # ),
            # datasets.SplitGenerator(
