...
train_logits1 = read_logits_from_jsonl(
    "/home/qd/PycharmProjects/SemEval_Test/A_Voting/A_mul_linear/lxr_Amul_train_logits.jsonl"
)  # 李祥润
train_logits2 = read_logits_from_jsonl(
    "/home/qd/PycharmProjects/SemEval_Test/A_Voting/A_mul_linear/deberta_mul_train_logits.jsonl"  # 汪洋
)
...
new_logits1 = read_logits_from_jsonl(
    "/home/qd/PycharmProjects/SemEval_Test/AAB-Test/A-muti-test/lxr_Amul_test_logits_process.jsonl"
)  # LXR
new_logits2 = read_logits_from_jsonl(
    "/home/qd/PycharmProjects/SemEval_Test/AAB-Test/A-muti-test/A_muti_deberta_test_logits_pro.json"  # WY
)
...
save_predictions_to_jsonl(
    predicted_classes,
    "subtask_a_multilingual_pro.jsonl",
    "/home/qd/PycharmProjects/SemEval_Test/AAB-Test/A-muti-test/A_muti_deberta_test_logits_pro.json",
)
