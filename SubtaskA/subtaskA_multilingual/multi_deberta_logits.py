...
# CUDA_VISIBLE_DEVICES=0 python deberta_mul_train_logits.py -tr /mnt/qust_521_big_2/public/SemEval2024/data/SubtaskA/subtaskA_train_multilingual.jsonl -t /mnt/qust_521_big_2/public/SemEval2024/data/SubtaskA/subtaskA_train_multilingual.jsonl -sb 'A' -m deberta-v3-large -p deberta_mul_train_logits.jsonl


# ? /home/qd/PycharmProjects/SemEval2024-Task8/Testdata/subtaskA_monolingual.jsonl
# ? CUDA_VISIBLE_DEVICES=0 python deberta_mul_train_logits.py -tr /mnt/qust_521_big_2/public/SemEval2024/data/SubtaskA/subtaskA_train_multilingual.jsonl -t /home/qd/PycharmProjects/SemEval2024-Task8/Testdata/subtaskA_multilingual.jsonl -sb 'A' -m deberta-v3-large -p A_muti_deberta_test_logits.jsonl


# ? CUDA_VISIBLE_DEVICES=0 python multi_deberta_logits.py -tr /mnt/qust_521_big_2/public/SemEval2024/test_data/multilingual_train_cl.jsonl -t /mnt/qust_521_big_2/public/SemEval2024/test_data/multilingual_train_cl.jsonl -sb 'A' -m deberta-v3-large -p A_multi_train_logits.jsonl

# ? CUDA_VISIBLE_DEVICES=0 python multi_deberta_logits.py -tr /mnt/qust_521_big_2/public/SemEval2024/test_data/multilingual_train_cl.jsonl -t /home/qd/PycharmProjects/SemEval2024-Task8/test_cleaned/subtaskA_multilingual_cl.jsonl -sb 'A' -m deberta-v3-large -p A_multi_test_logits.jsonl
