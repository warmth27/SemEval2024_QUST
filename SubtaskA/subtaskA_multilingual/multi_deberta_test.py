...
# ? 这是多语言 best model  deberta-v3-large

# CUDA_VISIBLE_DEVICES=0 python multi_deberta_test.py -tr /mnt/qust_521_big_2/public/SemEval2024/test_data/multilingual_train_cl.jsonl -t /home/qd/PycharmProjects/SemEval2024-Task8/test_cleaned/subtaskA_multilingual_cl.jsonl -sb 'A' -m deberta-v3-large -p A_multi_test_pre.jsonl
