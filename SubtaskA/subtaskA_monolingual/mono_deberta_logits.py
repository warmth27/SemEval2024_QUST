...
# ? CUDA_VISIBLE_DEVICES=0 python A_deberta_logits.py -tr /mnt/qust_521_big_2/public/SemEval2024/cleaned_data/A2_train_tr_cl.jsonl -t /home/qd/PycharmProjects/SemEval2024-Task8/Testdata/subtaskA_monolingual.jsonl -sb 'A' -m deberta-v3-large -p A_mono_deberta_test_logits.jsonl


# ? CUDA_VISIBLE_DEVICES=0 python mono_deberta_logits.py -tr /mnt/qust_521_big_2/public/SemEval2024/test_data/monolingual_train_cl.jsonl -t /home/qd/PycharmProjects/SemEval2024-Task8/test_cleaned/subtaskA_monolingual_cl.jsonl -sb 'A' -m deberta-v3-large -p A_mono_test_logits.jsonl


# LXR_TEST
# ? CUDA_VISIBLE_DEVICES=1 python mono_deberta_logits.py -tr /mnt/qust_521_big_2/public/SemEval2024/test_data/monolingual_train_cl.jsonl -t /home/qd/PycharmProjects/semeval_lxr/LXR_TEST/shorter.jsonl -sb 'A' -m deberta-v3-large -p lxr_shorter_logits.jsonl
