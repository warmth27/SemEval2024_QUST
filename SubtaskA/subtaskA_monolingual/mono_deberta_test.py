...
# CUDA_VISIBLE_DEVICES=0 python mono_deberta_test.py -tr /mnt/qust_521_big_2/public/SemEval2024/test_data/monolingual_train_cl.jsonl -t /home/qd/PycharmProjects/SemEval2024-Task8/test_cleaned/subtaskA_monolingual_cl.jsonl -sb 'A' -m deberta-v3-large -p A_mono_test_pre.jsonl


# ? 这是单语言best model  deberta-v3-large  
